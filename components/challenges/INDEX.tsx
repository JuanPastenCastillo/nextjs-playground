  ...
  return (
    <INDEX_ChallengesWrapper>
      {allDataChallenges.map((x, index) => {
        const hasSomethingSpecial = x.hasSomethingSpecial ? x.hasSomethingSpecial : null
          ...
          return (
            <>
              <li>
                ...
                <h2>Something Special!, is this → {hasSomethingSpecial.specificStyles?.numberOfCards} number</h2>
                <ul>
                        ...
                        <>
                          <li>
                            <Link
                              ...
                              {componentName && `Name of challenge: ${componentName?.[indexDeep1].name} (${indexDeep1 + 1})`}
                            </Link>
                          </li>
                        </>
                      )
